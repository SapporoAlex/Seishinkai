  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 192
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_satozuka_01.jpg" alt="Satozuka Karate Class practice session" width="247" height="149" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_satozuka_02.jpg" alt="Satozuka Karate Class practice session" width="247" height="149" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_satozuka_03.jpg" alt="Satozuka Karate Class practice session" width="247" height="149" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_satozuka_04.jpg" alt="Satozuka Karate Class practice session" width="247" height="149" loading="lazy">
        </figure>
      </div>
