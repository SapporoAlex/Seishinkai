  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 168
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_misono_01.jpg" alt="美園支部の稽古風景" width="336" height="185" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_misono_02.jpg" alt="美園支部の稽古風景" width="336" height="185" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_misono_03.jpg" alt="美園支部の稽古風景" width="336" height="185" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_misono_04.jpg" alt="美園支部の稽古風景" width="336" height="185" loading="lazy">
        </figure>
      </div>
