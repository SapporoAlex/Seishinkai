  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 168
      ...
      <div class="detail-page__img-text-pair">
        <div class="u-col u-w-full u-jc-start u-ai-center u-col-reverse">
          <div class="detail-media--med u-w-half">
            <figure>
              <img src="/assets/images/dojo/img_sanaijidosha.png" alt="Sanai Jidosha logo" width="300" height="115" loading="lazy">
            </figure>
          </div>
        ...
        <div class="detail-media--bigger">
          <figure>
            <img src="/assets/images/dojo/img_sakaemachi-map_02.png" alt="After entering through the entrance, please go up the stairs. We are using the training room on the third floor, provided by San-ai Motor. Entry to areas other than the training room is prohibited." width="282" height="180" loading="lazy">
          </figure>
        </div>
      </div>
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_sakaemachi_01.jpg" alt="Seishinkai Sakaemachi Branch practice session" width="282" height="180" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_sakaemachi_02.jpg" alt="Seishinkai Sakaemachi Branch practice session" width="282" height="180" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_sakaemachi_03.jpg" alt="Seishinkai Sakaemachi Branch practice session" width="282" height="180" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_sakaemachi_04.jpg" alt="Seishinkai Sakaemachi Branch practice session" width="282" height="180" loading="lazy">
        </figure>
      </div>
