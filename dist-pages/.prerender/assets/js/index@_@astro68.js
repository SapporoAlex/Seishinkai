  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 273
      ...
      <div class="detail-media">
        <img src="/assets/images/legacy/base/iqi.jpg" alt="パークヒルズ 外観" width="633" height="149" loading="lazy">
      </div>

      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/oasa/Image1.jpg" alt="月曜クラスの稽古風景" width="284" height="141" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/oasa/Image2.jpg" alt="金曜クラスの稽古風景" width="286" height="133" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/oasa/img6.jpg" alt="木曜クラスの稽古風景" width="325" height="148" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/oasa/Image3.jpg" alt="清心館大麻道場 全景" width="307" height="205" loading="lazy">
        </figure>
      </div>
