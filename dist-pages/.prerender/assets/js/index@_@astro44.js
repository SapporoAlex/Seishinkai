  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 138
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/kikusui/Image3.jpg" alt="菊水支部の稽古風景(水曜・木曜クラス)" width="251" height="136" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/kikusui/Image2.jpg" alt="菊水支部の稽古風景(土曜クラス)" width="251" height="137" loading="lazy">
        </figure>
      </div>
