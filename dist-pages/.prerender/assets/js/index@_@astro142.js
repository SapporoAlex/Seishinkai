  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 130
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/kitashiroishi/Image1.jpg" alt="Kita-Shiroishi Branch practice session (Tuesday class)" width="276" height="101" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/kitashiroishi/Image2.jpg" alt="Kita-Shiroishi Branch practice session (Friday class)" width="271" height="103" loading="lazy">
        </figure>
      </div>
