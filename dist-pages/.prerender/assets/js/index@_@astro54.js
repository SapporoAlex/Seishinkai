  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 226
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/m-ainosato/Image1.jpg" alt="南あいの里支部の稽古風景" width="432" height="205" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/m-ainosato/2.jpg" alt="拓北あいの里地区センター" width="345" height="226" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/legacy/dojo/m-ainosato/img2.jpg" alt="コープあいの里" width="262" height="163" loading="lazy">
        </figure>
      </div>
