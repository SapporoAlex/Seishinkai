...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<section class="news">
    <div class="page-container">
      ...
      <p>
        <a class="newsletter-list__show-more" href="/news/newsletter/">
          View newsletter list (members only, password required)
        </a>
      </p>
      <p class="news__note">
        ※ You'll be asked for a password when you click through. Japanese-language PDFs only. If you don't have the password, please contact the office below.
      </p>
