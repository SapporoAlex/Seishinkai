  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 143
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/kawashimo/Image1.jpg" alt="Kawashimo Branch practice session" width="270" height="115" loading="lazy">
        </figure>
      </div>
      ...
      <div class="detail-gallery">
        <figure>
          <a href="/assets/pdf/kawashimo.pdf" target="_blank" rel="noopener noreferrer">
            <img src="/assets/images/legacy/dojo/kawashimo/img3.jpg" alt="Coop Sapporo Kawashimo Store (facing Kita-13-jo-dori)" width="253" height="143" loading="lazy">
          </a>
          <figcaption>Facing Kita-13-jo-dori</figcaption>
        </figure>
        <figure>
          <a href="/assets/pdf/kawashimo.pdf" target="_blank" rel="noopener noreferrer">
            <img src="/assets/images/legacy/dojo/kawashimo/img4.jpg" alt="The side loading-dock entrance" width="254" height="147" loading="lazy">
          </a>
