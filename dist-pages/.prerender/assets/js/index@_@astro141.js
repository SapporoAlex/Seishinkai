...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const entries = [
    ...
    },
    {
      ...
      schedule: ["Saturday 18:45"],
      link: "/en/dojo/obihiro/"
    }
  ];
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Karate Classes in Obihiro, Eniwa & Asahikawa", "description": "Directory of Seishinkai Karate dojos and classes in Eniwa (Shimamatsu) and Obihiro City. Find training days for each branch.", "lang": "en", "path": "/en/dojo/kitahiro/" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<section class="dojo-list">
    <div class="page-container">
      <div class="section__title-area">
        <span class="section-label">DOJO LIST</span>
        <h1 class="section-title">Karate Dojos in Eniwa City & Karate Classes in Obihiro City</h1>
      </div>
...
` })}`;
}, "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/kitahiro/index.astro", void 0);

const $$file = "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/kitahiro/index.astro";
const $$url = "/en/dojo/kitahiro";
