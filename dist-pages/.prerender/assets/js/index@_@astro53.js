  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 184
      ...
      <p class="detail-page__note">
        ※第1部：白帯～水色帯、18:15～19:00 ／ 第2部：青帯以上、19:05～20:00。
      </p>
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_01.jpg" alt="京極支部の稽古風景" width="441" height="270" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_02.jpg" alt="京極支部の稽古風景" width="441" height="270" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_03.jpg" alt="京極支部の稽古風景" width="441" height="270" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_04.jpg" alt="京極支部の稽古風景" width="441" height="270" loading="lazy">
        </figure>
      </div>

      <div class="section__title-area">
        <h2 class="detail-page__heading">以前の稽古場所</h2>
      </div>
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_bld-former_01.jpg" alt="京極支部の以前の稽古場所、虻田郡京極町字京極615番地、廣徳寺" width="301" height="145" loading="lazy">
          <figcaption>
        ...
        <figure>
          <img src="/assets/images/dojo/img_kyogoku_bld-former_02.jpg" alt="京極支部の以前の稽古場所、虻田郡京極町字三崎68番地、福祉センター" width="301" height="145" loading="lazy">
          <figcaption>
            <a href="https://www.google.com/maps/place/京極町+社会福祉協議会/@42.860568,140.880615,15z/data=!4m2!3m1!1s0x0:0x444da41dc2d6035" target="_blank" rel="noopener">虻田郡京極町字三崎68番地　福祉センター
            </a>
          </figcaption>
        </figure>
      </div>
