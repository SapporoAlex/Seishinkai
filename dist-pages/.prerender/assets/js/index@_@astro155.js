  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 131
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_naganuma_01.jpg" alt="Naganuma Branch practice session" width="237" height="124" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_naganuma_02.jpg" alt="Naganuma Branch practice session" width="237" height="124" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_naganuma_03.jpg" alt="Naganuma Branch practice session" width="237" height="124" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_naganuma_04.jpg" alt="Naganuma Branch practice session" width="237" height="124" loading="lazy">
        </figure>
      </div>
