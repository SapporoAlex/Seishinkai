  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    alt: "Mikami Building (Kamome Academy)"
      ...
      <div class="detail-gallery">
        <!-- <figure>
          <img
            src="/assets/images/dojo/img_chuouhigashi_01.jpg"
        ...
        <figure>
          <img
            src="/assets/images/dojo/img_chuouhigashi_02.jpg"
            alt="Training session"
            width="326"
            height="192"
            loading="lazy"
      ...
      ${renderComponent($$result2, "DojoContactSection", $$DojoContactSection, { "dojoName": "Chuo Higashi Branch", "subject": "Chuo Higashi Branch Trial Lesson & Membership Inquiry" })}
    </div>
  </section>
` })}`;
