  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    <h2 class="detail-page__heading">白石区の空手道場です</h2>
      ...
      <div class="detail-page__img-text-pair--reverse">
        ...
        <figure>
          <img src="/assets/images/dojo/img_shiroishi_2.jpg" alt="本通清心館(焼肉徳寿の隣)" width="253" height="144" loading="lazy">
          <figcaption>2026年8月より白石福祉会館2Fで木曜18:30より活動中
          </figcaption>
        </figure>
        </div>
        <p>
        ...
        <div class="detail-page__img-text-pair">
          ...
          <figure>
            <img src="/assets/images/dojo/img_shiroishi_6.jpg" alt="本通清心館の外観" width="234" height="144" loading="lazy">
          </figure>
                    <figure>
            <img src="/assets/images/dojo/img_shiroishi_5.jpg" alt="本通清心館の外観" width="234" height="144" loading="lazy">
          </figure>
    ...
    <div class="detail-gallery">
        ...
        <figure>
          <img src="/assets/images/dojo/img_shiroishi_3.jpg" alt="本通清心館(焼肉徳寿の隣)" width="253" height="144" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_shiroishi_4.jpg" alt="本通清心館(焼肉徳寿の隣)" width="253" height="144" loading="lazy">
        </figure>
      </div>
