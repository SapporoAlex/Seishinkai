...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    width: 455,
    height: 305
  }, "address": "Ainosato 4-jo 6-chome, Kita-ku, Sapporo, Takuhoku Kaikan", "mapHref": "https://www.google.com/maps/place/拓北会館/@43.164024,141.403793,15z/data=!4m5!3m4!1s0x0:0x63d720b3ff077d1d!8m2!3d43.164024!4d141.403793", "mapQuery": "43.164024,141.403793" })}
      ...
      <div class="detail-gallery">
        ...
        <figure>
          <img src="/assets/images/dojo/img_ainosato_02.jpg" alt="Training session at the Ainosato Branch" width="455" height="305" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_ainosato_03.jpg" alt="Training session at the Ainosato Branch" width="426" height="248" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_ainosato_04.jpg" alt="Training session at the Ainosato Branch" width="455" height="305" loading="lazy">
        </figure>
      </div>
