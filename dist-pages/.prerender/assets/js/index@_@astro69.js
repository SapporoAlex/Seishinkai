  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    { src: "/assets/images/instructors/kudo.jpg", alt: "担当 工藤", name: "工藤" }
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_obihiro_01.jpg" alt="帯広支部の稽古風景" width="352" height="159" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_obihiro_02.jpg" alt="帯広支部の稽古風景" width="352" height="159" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_obihiro_03.jpg" alt="帯広支部の稽古風景" width="352" height="159" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_obihiro_04.jpg" alt="帯広支部の稽古風景" width="352" height="159" loading="lazy">
        </figure>
      </div>
