  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 138
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_kikusui_01.jpg" alt="Kikusui Branch practice session (Wednesday & Thursday classes)" width="251" height="136" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kikusui_02.jpg" alt="Kikusui Branch practice session (Saturday class)" width="251" height="137" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kikusui_03.jpg" alt="Kikusui Branch practice session (Wednesday & Thursday classes)" width="251" height="136" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_kikusui_04.jpg" alt="Kikusui Branch practice session (Saturday class)" width="251" height="137" loading="lazy">
        </figure>
      </div>
