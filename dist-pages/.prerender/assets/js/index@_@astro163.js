  ...
  ${maybeRenderHead()}<section class="dojo-list">
    ...
    height: 182
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/dojo/img_ryoku_01.jpg" alt="Ryokuentai Branch practice session" width="288" height="170" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_ryoku_02.jpg" alt="Ryokuentai Branch practice session" width="288" height="170" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_ryoku_03.jpg" alt="Ryokuentai Branch practice session" width="288" height="170" loading="lazy">
        </figure>
        <figure>
          <img src="/assets/images/dojo/img_ryoku_04.jpg" alt="Ryokuentai Branch practice session" width="288" height="170" loading="lazy">
        </figure>
      </div>
