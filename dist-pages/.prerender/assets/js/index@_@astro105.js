...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Chuo Ward Fushimi Karate Class (Heiwadori Branch)", "description": "Introducing the Fushimi Branch (Heiwadori Branch) of Seishinkai Karate at Fushimi Kaikan in Chuo Ward, Sapporo. A class centered on Junior Karate and Parent-Child Karate — see training days and venue information.", "lang": "en", "path": "/en/dojo/cyuo-m/" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<section class="dojo-list">
    <div class="page-container">
      ...
      <h2 class="detail-page__heading">Chuo Ward Fushimi Karate Class - Seishinkai Fushimi Branch</h2>
      ...
      ${renderComponent($$result2, "BranchInfoCard", $$BranchInfoCard, { "name": "Heiwadori Branch", "facts": [
    ...
    height: 200
      ...
      <div class="detail-gallery">
        <figure>
          <img src="/assets/images/legacy/dojo/cyuo-m/Image1.jpg" alt="Training session at the Fushimi Branch" width="292" height="182" loading="lazy">
        </figure>
      </div>
...
` })}`;
}, "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/cyuo-m/index.astro", void 0);

const $$file = "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/cyuo-m/index.astro";
const $$url = "/en/dojo/cyuo-m";
