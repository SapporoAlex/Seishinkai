...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const entries = [
    ...
    },
    {
      ...
      link: "/en/dojo/ebetsu/ebetsu/"
    },
    {
      no: 4,
      marker: "●",
      name: "AEON Ebetsu Karate Club",
      address: "34 Saiwaicho, Ebetsu, AEON Ebetsu 3F",
      schedule: ["Sunday 10:00", "Sunday 13:00 (in preparation)"]
    },
    {
      no: 5,
      marker: "★",
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Karate Classes in Ebetsu, Iwamizawa & Ishikari", "description": "A directory of Seishinkai Karate dojos and classes in Ebetsu, Iwamizawa, and Ishikari cities, including Oasa Dojo and the training schedules of each branch.", "lang": "en", "path": "/en/dojo/ebetsu/" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<section class="dojo-list">
    <div class="page-container">
      <div class="section__title-area">
        <span class="section-label">DOJO LIST</span>
        <h1 class="section-title">
          Karate Dojos & Classes in Ebetsu City, Ishikari City & Iwamizawa City
        </h1>
      </div>
      ...
      <p class="detail-page__note">
        Related link:<a href="https://www.ebe-2.net/楽しみながらできる！キッズ空手倶楽部/" target="_blank" rel="noopener">AEON Ebetsu Karate Club (Kids Karate Club)</a>
      </p>

      <div class="detail-media">
        <img src="/assets/images/legacy/photo/Image2.jpg" alt="Seishinkai Karate training scene" width="570" height="340" loading="lazy">
      </div>
...
` })}`;
}, "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/ebetsu/index.astro", void 0);

const $$file = "C:/Users/McKinley Alex/Documents/GitHub/Seishinkai/src/pages/en/dojo/ebetsu/index.astro";
const $$url = "/en/dojo/ebetsu";
